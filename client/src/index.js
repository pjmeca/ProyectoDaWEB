    ...
    <>
        ...
        (
            <Switch>
                ...
                <Route exact path='/login' render={() => <RedirectTo puerto="8090" ruta="restaurantes" />}></Route>                
            ...
            <Switch>
                ...
                <Route exact path='/restaurantes/:id/modificar' render={(props) => <Modificar id={props.match.params.id} />}></Route>
